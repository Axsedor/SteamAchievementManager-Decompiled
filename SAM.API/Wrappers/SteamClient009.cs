...
namespace SAM.API.Wrappers
{
  public class SteamClient009 : NativeWrapper<ISteamClient009>
  {
    ...
    {
      return this.Call<bool, SteamClient009.NativeReleaseSteamPipe>(this.Functions.ReleaseSteamPipe, new object[1]
      {
        (object) this.ObjectAddress
      });
    }
    ...
    private delegate bool NativeReleaseSteamPipe(IntPtr thisObject);
